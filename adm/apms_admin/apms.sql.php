...
sql_query(" ALTER TABLE `{$g5['config_table']}`
				...
				ADD `as_intro_skin` varchar(255) NOT NULL DEFAULT '',
				ADD `as_mobile_intro_skin` varchar(255) NOT NULL DEFAULT '',
				ADD `as_tag_skin` varchar(255) NOT NULL DEFAULT 'basic',
				ADD `as_mobile_tag_skin` varchar(255) NOT NULL DEFAULT 'basic',
				ADD `as_misc_skin` varchar(255) NOT NULL DEFAULT 'basic',
				ADD `as_lang` varchar(255) NOT NULL DEFAULT 'korean',
...
sql_query(" ALTER TABLE `{$g5['board_table']}`
				...
				ADD `as_purifier` tinyint(4) NOT NULL DEFAULT '0',
