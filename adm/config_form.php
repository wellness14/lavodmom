...
// APMS Skin
if(!isset($config['as_tag_skin'])) {
    sql_query(" ALTER TABLE `{$g5['config_table']}`
                    ADD `as_tag_skin` varchar(255) NOT NULL DEFAULT '' AFTER `cf_10`,
                    ADD `as_mobile_tag_skin` varchar(255) NOT NULL DEFAULT '' AFTER `as_tag_skin` ", false);
}
